...
export function NotificationDropdown({ onClose }: NotificationDropdownProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute right-0 top-full mt-2 w-80 bg-white dark:bg-card rounded-xl shadow-lg border border-gray-100 dark:border-border z-50"
    >
          ...
          {notifications.map((notif) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-gray-900 dark:text-foreground truncate">{notif.title}</p>
