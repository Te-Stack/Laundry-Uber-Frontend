  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex-1 flex max-w-6xl mx-auto w-full px-4 py-6 gap-4">
        {/* Conversation list */}
        <div className="w-full md:w-72 lg:w-80 bg-white rounded-xl border overflow-hidden flex-shrink-0">
        ...
        {/* Message thread */}
        <div className="flex-1 bg-white rounded-xl border overflow-hidden flex flex-col min-h-0">
          {userId ? (
            <>
