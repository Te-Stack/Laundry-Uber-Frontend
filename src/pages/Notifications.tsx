    ...
    <div className="min-h-screen bg-gray-50 dark:bg-background">
      ...
      <main className="max-w-3xl mx-auto px-4 py-8">
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-full text-sm font-medium whitespace-nowrap transition-colors ${
                activeFilter === tab.value
                  ...
                  : 'bg-white dark:bg-card border dark:border-border text-gray-600 dark:text-gray-400 hover:bg-gray-50 dark:hover:bg-muted'
              }`}
            >
              {tab.label}
            </button>
        ...
        {isLoading ? (
          ...
          <div className="bg-white dark:bg-card rounded-xl border dark:border-border divide-y dark:divide-border">
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-start justify-between gap-2">
                    <p className={`text-sm font-medium ${!notif.isRead ? 'text-gray-900 dark:text-foreground' : 'text-gray-600 dark:text-gray-400'}`}>
                      {notif.title}
                    </p>
